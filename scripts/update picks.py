...
def fetch_russell1000_growth():
    ...
    url = ("https://www.ishares.com/us/products/239706/ishares-russell-1000-growth-etf/"
           "1467271812596.ajax?fileType=csv&fileName=IWF_holdings&dataType=fund")
    text = http_get(url, timeout=40, headers={
        "Accept": "text/csv,text/plain,*/*",
        "Referer": "https://www.ishares.com/us/products/239706/ishares-russell-1000-growth-etf",
