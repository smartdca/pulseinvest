...
async function runBacktest() {
  ...
  try {
    ...
    btCountUp($('btROI1'), r1.roi, { duration: 1800, decimals: 1, prefix: r1.roi>=0?'+':'', suffix: '%' });
    btCountUp($('btVal1'), r1.finalVal, { duration: 1800, decimals: 0, prefix: '$' });
    btCountUp($('btROI2'), r2.roi, { duration: 1800, decimals: 1, prefix: r2.roi>=0?'+':'', suffix: '%' });
    btCountUp($('btVal2'), r2.finalVal, { duration: 1800, decimals: 0, prefix: '$' });
    btCountUp($('btInvested'), r1.totalInvested, { duration: 1800, formatFn: isDesktopStats ? btFmtK : null, decimals: 0, prefix: isDesktopStats ? '' : '$' });
    ...
    if(Math.abs(r1.finalVal) >= 10000000) {
      btCountUp($('btHeroAmount'), r1.finalVal / 1000000, { duration: 3000, decimals: 1, prefix: '$', suffix: 'M' });
    } else {
      btCountUp($('btHeroAmount'), r1.finalVal, { duration: 3000, decimals: 0, prefix: '$' });
    }
