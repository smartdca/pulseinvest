...
.breadcrumb{display:inline-block;font-size:13px;color:var(--ink2);text-decoration:none;font-family:var(--font-sans);margin-bottom:16px;}
...
.tab-btn{flex:none;padding:7px 18px;border:none;background:transparent;border-radius:32px;font-size:11px;font-weight:500;color:rgba(255,255,255,.45);cursor:pointer;transition:all .22s;display:flex;flex-direction:column;align-items:center;gap:2px;white-space:nowrap;-webkit-tap-highlight-color:transparent;}
...
{body_zh}
  ...
  <footer class="site-footer-top" style="margin-top:48px;padding:32px 0;border-top:1px solid var(--border);text-align:center;">
    <a class="footer-brand" href="../index.html" style="text-decoration:none;display:inline-flex;align-items:center;justify-content:center;margin-bottom:14px;">
    ...
    <div style="display:flex;gap:16px;justify-content:center;margin-bottom:14px;font-size:13px;">
      <a href="../insights.html" style="color:var(--ink2);text-decoration:none;">Insights</a>
      <a href="../privacy.html" style="color:var(--ink2);text-decoration:none;">Privacy Policy</a>
    </div>
    <p style="font-size:11px;color:var(--ink3);line-height:1.6;">DCAcafe is an informational tool only and does not constitute financial or investment advice. All investment decisions carry risk.</p>
  </footer>
...
function applyLang(lang){{
  ...
  document.getElementById('breadcrumb').textContent = isZh ? '← Insights' : '← Insights';
}}
