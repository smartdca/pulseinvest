...
function setLang(lang,e){{
  ...
  if(isZh){{
    ...
    document.getElementById('cat').textContent='{category_en_js}';
    document.getElementById('ttl').textContent='{title_en_js}';
    document.getElementById('sub').textContent='{subtitle_en_js}';
    document.getElementById('tag').textContent='{tag_en_js}';
