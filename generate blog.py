...
.action-bar{position:fixed;bottom:0;left:0;right:0;width:100%;display:flex;background:var(--surface);border-top:1px solid var(--border);padding:10px 16px;padding-bottom:calc(10px + env(safe-area-inset-bottom));z-index:200;box-shadow:0 -4px 16px rgba(0,0,0,.06);}
.action-btn{flex:1;display:flex;align-items:center;justify-content:center;gap:6px;background:none;border:none;padding:10px 0;font-size:14px;font-weight:500;font-family:var(--font-sans);color:var(--ink2);cursor:pointer;-webkit-tap-highlight-color:transparent;}
...
<div class="action-bar">
  <button class="action-btn" id="likeBtn" onclick="toggleLike()" aria-label="Like">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
    <span id="likeLabel">Like</span><span class="like-count" id="likeCount"></span>
  </button>
  <button class="action-btn" onclick="sharePost()" aria-label="Share">
