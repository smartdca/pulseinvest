...
.dca-chip{display:inline-flex;align-items:center;gap:5px;flex-shrink:0;font-size:12px;font-weight:600;font-family:var(--font-sans);background:var(--bg2);color:var(--ink2);padding:5px 12px;border-radius:20px;text-decoration:none;border:1px solid var(--border);transition:background .15s;}
.dca-chip:active{background:var(--al);}
.dca-chip-score{font-variant-numeric:tabular-nums;font-weight:700;}
.dca-chip.triggered{background:var(--al);color:var(--accent);border-color:var(--accent);}
.dca-chip.triggered .dca-chip-score{color:var(--accent);}
