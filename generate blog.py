...
.ticker-row{display:flex;gap:6px;margin:0 0 24px;overflow-x:auto;-ms-overflow-style:none;scrollbar-width:none;}
...
for post in posts:
    ...
    if tickers:
        ...
        ticker_row_html = f'<div class="ticker-row">{chips}</div>'
    else:
        ticker_row_html = ""
