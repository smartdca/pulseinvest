/* ══════════════════════════════════════════════════════════════
   ...
   欄位:
     ...
     duel    選填。標記「首頁桌機對比卡」的主角。只能有一支。
             ...
             ※ 對比卡需要另外配 wordmark 圖與對決敘事,所以跟排序脫鉤,
               不會因為新資產置頂就被動換角。
     name    顯示名{zh,en} / cat 類別
   用法:頁面 <head> 內 <script src="/assets.js"></script>(在主程式之前)。
   ══════════════════════════════════════════════════════════════ */
window.DCA_ASSETS = [
  { ticker:'BTC',  query:'BTC-USD',        name:{ zh:'比特幣', en:'Bitcoin' }, cat:'crypto' },
  { ticker:'NFLX', domain:'netflix.com', duel:true, name:{ zh:'網飛', en:'Netflix' }, cat:'growth' },
